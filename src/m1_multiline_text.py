...
text_box.insert(tk.END, "AI is taking over the world\n")
text_box.insert(tk.END, "DUNE 2 was a great movie\n")
text_box.insert(tk.END, "Star Wars dropped off\n")

inserted_text = text_box.get("1.0", tk.END)
print(inserted_text)
